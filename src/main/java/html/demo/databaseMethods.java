...
public class databaseMethods {
    public static String[][] getData(String sql) {
        ...
        String DBLocation = System.getProperty("user.dir")  + "\\src\\main\\resources\\static\\data\\database\\RestaurantNEA.accdb"; // Gets the location of the database
        try {
    ...
    public static void insertData(String sql) {
        String DBLocation = System.getProperty("user.dir")  + "\\src\\main\\resources\\static\\data\\database\\RestaurantNEA.accdb"; // Gets location of the database
        try {
            Connection connection = DriverManager.getConnection("jdbc:ucanaccess://" + DBLocation); // Creates a connection to the database
